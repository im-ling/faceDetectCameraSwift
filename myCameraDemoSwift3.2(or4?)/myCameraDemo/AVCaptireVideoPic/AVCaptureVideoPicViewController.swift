...
//            resultImage = fixOrientation(aImage: resultImage)
//            resultImage = fixedOrientationNew(image: resultImage)
            resultImage = resultImage.fixedOrientation()
            print(resultImage.size)
//            print(resultImage.imageOrientation)
...
//            let smallLayer = CALayer.init()
//            smallLayer.borderColor = UIColor.red.cgColor
//            smallLayer.borderWidth = 1
...
//            let results = detecotr?.features(in: ciImage)
...
//            if self.smallPicture.layer.sublayers != nil{
//                for item in self.smallPicture.layer.sublayers!{
//                    item.removeFromSuperlayer()
//                }
//            }
